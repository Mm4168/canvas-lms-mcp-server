...
exports.CanvasToolRegistry = void 0;
...
class CanvasToolRegistry {
    ...
    registerTool(tool) {
        ...
        logger_1.default.debug(`Registered tool: ${tool.name}`);
    }
    registerPrompt(prompt) {
        this.prompts.set(prompt.name, prompt);
        logger_1.default.debug(`Registered prompt: ${prompt.name}`);
    }
    ...
    async executeTool(toolName, args, canvasClient) {
...
exports.CanvasToolRegistry = CanvasToolRegistry;
exports.default = CanvasToolRegistry;
